...
const Card3 = () => {
    let card = [
        {
          status: "✔️", plan: "Unlimited User"
        },
        {
          status: "✔️", plan: "15GB Storage"
        },
        {
        ...
        {
          status: "✔️", plan: "Unlimited Free Sub-Domains"
        },
        {
          status: "✔️", plan: "Monthly Status Reports"
        },
      ];
      return (
        <div>
          <div class="container bg-light card p-3 mx-auto" >
            <div class="header d-flex flex-column" >
                <div class="fs-6 fw-light"> PRO </div>
                <div class="fs-6"><h2>$49</h2>/per month</div>     
                <hr></hr>
            </div>
            <div>
              <div class="d-flex gap-2 ">
                <ul class="plan-Lists text-start gap-3">
