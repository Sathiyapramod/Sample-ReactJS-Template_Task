...
const Card1 = () => {
  let card = [
    {
      status: "✔️", plan: "Single User"
    },
    {
      status: "✔️", plan: "5GB Storage"
    },
    {
    ...
    {
      status: "❌", plan: "Unlimited Private Projects"
    },
    {
      status: "❌", plan: "Dedicated Phone Supports"
    },
    {
      status: "❌", plan: "Free Sub-Domains"
    },
    {
  ...
  return (
    <div>
      <div class="container bg-light card p-3 mx-auto rounded-2 shadow" >
        <div class="header d-flex flex-column" >
            <div class="fs-6 fw-light"> FREE</div>
            <div class="fs-6"><h2>$0</h2>/per month</div>     
            <hr></hr>
        </div>
        <div>
